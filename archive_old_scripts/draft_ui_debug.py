...
def load_state():
    ...
    try:
        ...
        if 'injury_status' not in available_df.columns:
            ...
            # injury_data = get_current_injury_data() # Commented out as per edit hint
            # if not injury_data.empty: # Commented out as per edit hint
            #     available_df = add_injury_status_to_dataframe(available_df, injury_data) # Commented out as per edit hint
            #     print("✅ Injury data re-added to loaded state") # Commented out as per edit hint
            # else: # Commented out as per edit hint
                # Add empty injury columns if no data # Commented out as per edit hint
                available_df['injury_status'] = None # Commented out as per edit hint
                available_df['injury_description'] = "" # Commented out as per edit hint
                available_df['injury_icon'] = "" # Commented out as per edit hint
...
def suggest():
    ...
    if all_available:
        ...
        try:
            ...
            # Use the trained CatBoost model to get actual predictions
            from draft_optimizer import load_model, create_football_features
